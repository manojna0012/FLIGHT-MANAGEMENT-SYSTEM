...
date1 = DateEntry(date, font=('Microsoft YaHei UI Light',15,'bold'), width=40, bd=0, fg='grey', bg='white')
date1.place(x=395,y=339)
date1.insert(0,'DD-MM-YYYY')
date1.bind('<FocusIn>',mm)

ttk.Button(date, text='Calendar', command=example).place(x=340,y=326)
